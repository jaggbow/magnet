...
#SBATCH --job-name=magnet_gnn_2d_b1_64_irregular
...
#SBATCH --time=1:00:00
#SBATCH --array=1-5  
#SBATCH -o /network/scratch/o/oussama.boussif/slurms/magnet_gnn_2d_b1_64_irregular-slurm-%A_%a.out  
...
datamodule.train_path='/home/mila/o/oussama.boussif/scratch/pdeone/data/B1/uniform/burgers_train_irregular_B1_64.h5' \
