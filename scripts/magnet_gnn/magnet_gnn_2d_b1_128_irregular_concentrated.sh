...
#SBATCH --job-name=magnet_gnn_2d_b1_128_irregular_concentrated
...
#SBATCH --time=1:00:00
#SBATCH --array=1-5  
#SBATCH -o /network/scratch/o/oussama.boussif/slurms/magnet_gnn_2d_b1_128_irregular_concentrated-slurm-%A_%a.out  
...
datamodule.train_path='/home/mila/o/oussama.boussif/scratch/pdeone/data/B1/concentrated/burgers_train_irregular_B1_128.h5' \
