...
#SBATCH --job-name=mpnn_2d_b1_256_irregular_concentrated
...
#SBATCH --time=2:00:00
#SBATCH --array=1-5  
#SBATCH -o /network/scratch/o/oussama.boussif/slurms/mpnn_2d_b1_256_irregular_concentrated-slurm-%A_%a.out  
