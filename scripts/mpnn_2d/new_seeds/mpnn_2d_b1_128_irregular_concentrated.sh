...
#SBATCH --job-name=mpnn_2d_b1_128_irregular_concentrated
...
#SBATCH --time=1:30:00
#SBATCH --array=1-5  
#SBATCH -o /network/scratch/o/oussama.boussif/slurms/mpnn_2d_b1_128_irregular_concentrated-slurm-%A_%a.out  
