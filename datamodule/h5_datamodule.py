...
class HDF5DatamoduleSlide(pl.LightningDataModule):
    def __init__(
        self, 
        name='h5_datamodule_slide',
        train_path="/content/drive/MyDrive/MILA/snapshots.h5", 
        val_path="/content/drive/MyDrive/MILA/snapshots.h5", 
        test_path="/content/drive/MyDrive/MILA/snapshots.h5",
        nt_train=128,
    ...
    def setup(self, stage = None):
        ...
        self.train_dataset = HDF5DatasetSlide( 
                path=self.train_path,
                mode='train',
...
class HDF5DatamoduleImplicitSlide(pl.LightningDataModule):
    def __init__(
        self, 
        name='h5_datamodule_implicit_slide',
        train_path="/content/drive/MyDrive/MILA/snapshots.h5", 
        val_path="/content/drive/MyDrive/MILA/snapshots.h5", 
        test_path="/content/drive/MyDrive/MILA/snapshots.h5",
        nt_train=128,
    ...
    def setup(self, stage = None):
        ...
        self.train_dataset = HDF5DatasetImplicitSlide( 
                path=self.train_path,
                mode='train',
                sampling=self.sampling,
                time_slice=self.time_slice,
